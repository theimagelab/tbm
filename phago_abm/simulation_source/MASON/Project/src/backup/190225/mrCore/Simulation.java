...
import mrFilesystem.FileSystemIO;
...
public abstract class Simulation extends SimState
{
	...
	public static final String defaultOutputDir = "results/test";
	...
	public static double endTime = 50.0;		// when to terminate the simulation. 
	public static double timeSlice = 0.5;  		// duration covered by a stimulation time-step. In minutes.
	...
	public static int tissueWidth = 412;						// in micrometers.	
	public static int tissueHeight = Simulation.tissueWidth;  	// in micrometers.
	public static int tissueDepth = 100;						// in micrometers.
