        ...
        il = new ItemListener()
            ...
            public void itemStateChanged(ItemEvent e)
                ...
                if (e.getStateChange() == ItemEvent.SELECTED)
                    {                    
                    getBarRenderer().setDefaultItemLabelsVisible(true);
                    getStackedBarRenderer().setDefaultItemLabelsVisible(true);
                    getPercentageRenderer().setDefaultItemLabelsVisible(true);
                    }
                else
                    {
                    getBarRenderer().setDefaultItemLabelsVisible(false);
                    getStackedBarRenderer().setDefaultItemLabelsVisible(false);
                    getPercentageRenderer().setDefaultItemLabelsVisible(false);
                    }
                }
            };
