...
public class PieChartGenerator extends ChartGenerator
    ...
    public int getSeriesCount()
        ...
        return sa.length;  // we do this instead of returning the columns in the data set because hidden series don't have columns (stupid JFreeChart)
        }
    ...
    protected void buildChart()
        ...
        // Pie chart functionality (below) doesn't seem to work.
        // It's probably because the MASON version is not up to date with jfree charts.
        // We are not concerned with charting so I am putting a filler here to get this to build.
        // Wunna Kyaw 8th March 2022
