...
public abstract class Cell implements Steppable
{
	...
	public abstract Double3D getStartLoc();
	public abstract ArrayList<Double> getTurnData();
	public abstract void setStartLoc(Double3D loc);
	public abstract double getMeanderChance();
	public abstract void addMeanderCount();
	public abstract int getMeanderCount();
	public abstract ArrayList<Double> getBetaDistrParams();
	public abstract ArrayList<Double> getTurnParams();
}
