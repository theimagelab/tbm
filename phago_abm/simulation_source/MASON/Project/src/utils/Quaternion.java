 ...
 * 'orientation.transform([1.0,0.0,0.0])' will give the vector in absoltue space along which the cell currently faces. 
 * 
 ...
 * orientation. Hence, you need to calcualte the angle between the desired heading and the x axis, and express that 
...
public class Quaternion 
{
	...
	{
		double u1 = Simulation.rng.nextDouble();
		double u2 = Simulation.rng.nextDouble();
		double u3 = Simulation.rng.nextDouble();
	...
	/** Applies the transformation reprensted by this Quaternion to the specified vector. For example, this Quaternion
